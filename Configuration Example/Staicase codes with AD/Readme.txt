...
3. n < 2^q.
4. The number of value for "The_error_correcting_capability" must be v+1 and the first value of "The_error_correcting_capability" must be zero. The remaining values represent the error correcting capabilities for different zipper codes.