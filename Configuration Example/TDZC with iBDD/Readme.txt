...
Zippersetting.txt
1. The flag of "Runing_anchor_decoding_option" is equal to 0.
...
3. The value of "Number_of_zippper_codes" must be same with the value of "Number_of_zippper_codes" in GIISetting.txt.
